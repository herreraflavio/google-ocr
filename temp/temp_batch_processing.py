...
gcs_output_uri = "gs://ocr-bucket-fh/output/"  # Must end with a trailing slash `/`. Format: gs://bucket/directory/subdirectory/
...
gcs_input_uri = "gs://ocr-bucket-fh/Winnie_the_Pooh.pdf"  # Format: `gs://bucket/directory/file.pdf` or `gs://bucket/directory/`
