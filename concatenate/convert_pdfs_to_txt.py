...
def extract_text_from_pdfs(input_dir, output_dir):
    ...
    for file_name in os.listdir(input_dir):
        if file_name.endswith('.pdf'):
            ...
            output_file = os.path.join(output_dir, f"{os.path.splitext(file_name)[0]}.txt")  # Change to .txt extension
...
output_directory = "outputtxt_fitz"  # Adjust the output directory for .txt files
